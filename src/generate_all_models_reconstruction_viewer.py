  ...
  <script>
    ...
    function updateMetrics(model) {{
      ...
      const items=[
        ...
        {{label:`патчи поддержки: ${{m.active_candidate_planes}} активных / ${{m.candidate_planes}} всего`, help:'Это локальные hull наблюдаемых точек, по которым фитились плоскости. Их размер не равен размеру финальной грани. Активным назван кандидат, чья бесконечная плоскость после clipping образует грань модели.'}},
